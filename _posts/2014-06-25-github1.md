...
>>>>>>> 5e402dae36137701267c2ca2c8db05556d623cf3:_posts/2014-06-25-github1.md
...
=======
       git clone git@github.com:xxx/xxx-xxx.git 克隆远程项目到本地，在哪个文件夹执行，
...
=======
       git rm  /test/newtest 一处我们删除的那个文件 不然git不允许我们向远程仓库提交 
